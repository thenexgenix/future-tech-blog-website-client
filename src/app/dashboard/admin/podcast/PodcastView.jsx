...
export default function PodcastView({ initialPodcasts }) {
        ...
        <div className="text-white min-h-screen pb-5 md:p-12">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-[#262626]">
                ...
                <button
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-4 py-2.5 rounded-xl text-xs sm:text-sm transition duration-200 cursor-pointer"
                >
