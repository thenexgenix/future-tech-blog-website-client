                        ...
                        <div className="relative z-10 space-y-6">
                            ...
                            <div>
                                <Link
                                    ...
                                    href="/resources"
                                    className="bg-[#1A1A1A] hover:bg-[#222222] text-gray-300 hover:text-white border border-[#262626] rounded-xl px-5 py-2.5 text-sm font-medium transition-all duration-200 flex items-center w-fit gap-2"
                                >
                                    Explore Resources
